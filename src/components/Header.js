...
const Header = () => {
  return (
    <div className="flex w-full h-36 text-white font-barlow justify-between items-center">
      {/* Logo and HR Line */}
      ...
      {/* Nav Bar */}
      <div className="flex bg-white/10 items-center justify-center w-1/2 p-4 h-24 backdrop-blur-md">
        <a
          href="/"
